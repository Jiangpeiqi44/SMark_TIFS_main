...
sys.path.append(".")
sys.path.append("..")
from e4s.src.models.stylegan2.model import EqualLinear
from e4s.src.models.stylegan2.model import Generator
from e4s.src.models.encoders import psp_encoders
from e4s.src.models.encoders.psp_encoders import FSEncoder_PSP
from e4s.src.models.encoders.helpers import get_block, Flatten, bottleneck_IR, bottleneck_IR_SE
from e4s.src.models.stylegan2.model import EqualLinear, EqualConv2d
...
class Net3(nn.Module):
    ...
    def __init__(self,opts,):
        ...
        self.encoder_dual = FSEncoder_PSP(mode='ir_se', opts=self.opts)
        ...
        if self.opts.force_full_finetune:
            for param in self.G.parameters():
                param.requires_grad = True
            for param in self.G.style.parameters():
                param.requires_grad = False
            print('Force Full Finetune!')
