...
class BottleneckBlock128(nn.Module):
    def __init__(self, in_channels, out_channels, reduction, stride, attention=None):
        super().__init__()
...
class ResBlock128(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, blocks=1, block_type="BottleneckBlock128", reduction=8, stride=1, attention=None):
        super().__init__()
