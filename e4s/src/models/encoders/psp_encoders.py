...
sys.path.append(".")
sys.path.append("..")
from e4s.src.models.encoders.helpers import get_blocks, Flatten, bottleneck_IR, bottleneck_IR_SE, bottleneck_IR_SE_Ours
from e4s.src.models.stylegan2.model import EqualLinear, EqualConv2d
from e4s.src.models.encoders.helpers import get_block
