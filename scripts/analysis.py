...
def parse_args():
    ...
    parser.add_argument('--seq_dir', type=str, default='./experiment/sw(0.1)_st(mls)_arcface')
    parser.add_argument('--img_dir', type=str, default='./experiment/sw(0.1)_st(mls)_arcface/reconstructed')
    parser.add_argument('--output_dir', type=str, default='./experiment/sw(0.1)_st(mls)_arcface/verification')
    parser.add_argument('--facenet_mode', type=str, default='arcface')
    parser.add_argument('--facenet_dir', type=str, default='./saved_models')
