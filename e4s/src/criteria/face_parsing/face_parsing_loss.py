...
sys.path.append(".")
sys.path.append("..")
from e4s.src.criteria.face_parsing.unet import unet
from e4s.src.criteria.face_parsing.utils import generate_label, generate_label_plain
...
class FaceParsingLoss(nn.Module):
    def __init__(self,opts):
        ...
        self.G = unet()
        self.G.load_state_dict(torch.load(opts.face_parsing_model_path, map_location='cpu'))
        self.G.eval()
