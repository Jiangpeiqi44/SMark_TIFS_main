...
class TrainingOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--ffhq_dataset_root", default="/home/gdata/face/e4s/FFHQ", type=str)
...
class EvalV8Options:
    ...
    def initialize(self):
        ...
        exp_dir = "20241223_H0124_CAHQ-adamW-C0_9-L0_12-OPTIM"  # 20231207_H1131_sw-0.1_mw-1.5_mm-MSE_True 20231220_H1141_sw-0.1_mw-1.5_mm-MSE_True
        # exp_dir = '241023_IMCC_11_Residual'
        epoch_n = "00060"
        # self.parser.add_argument(
        #     "--aadblocks_dir",
        #     default=f"./experiment/{exp_dir}/CheckPoints/AAD_{epoch_n}.pth",
        ...
        self.parser.add_argument(
            "--Net3_dir",
            default=f"./experiment/{exp_dir}/BestResult/Net_best.pth",
            type=str,
        )
